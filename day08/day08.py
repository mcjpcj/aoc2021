...
for line in data:
    ...
    counter += np.count_nonzero((output_lengths == 2) | (output_lengths == 3) | (output_lengths == 4) |  (output_lengths == 7))
print(counter)
# Part two
...
def find_wire_map(input):
    ...
    mappings_3 = wire_cf | wire_map["a"] | wire_map["d"] | wire_map["g"]
    mappings_06 = np.ravel([list(wires) for wires in input[input_lengths == 6] if wires != mappings_9])
